  ...
  try {
    ...
    const users = await insertRows(client, '"User"',
      ...
      [
        ...
        ['hopeseraya', password, 'RELIEF_ORG'],
        ['crisisresponse', password, 'RELIEF_ORG'],
    ...
    const [org3, org4] = users.slice(15, 17).map(r => r.user_id);
    ...
    await insertRows(client, 'ReliefOrganization',
      ...
      [
        ...
        [org3, 'Hope Relief Malaysia', 'No. 7, Jalan Ampang, 50450 Kuala Lumpur', '0342561111', 'REJECTED', null],
        [org4, 'Crisis Response Team KL', '88 Jalan Raja Chulan, 50200 Kuala Lumpur', '0321172222', 'REVOKED', admin2],
      ]
    );
    ...
    console.log('  Users:               17  (2 admins, 4 orgs, 8 volunteers, 3 public)');
    console.log('  Relief Organizations: 4  (1 approved, 1 pending, 1 rejected, 1 revoked)');
